...
RSpec.describe Display do
  ...
  describe "#prompt_player" do
    it "prompts the player to make a move" do
      game = Game.new(Board.new(empty_board), StubDisplay.new, HumanDouble.new("X", self), HumanDouble.new("O", self))
  ...
  describe "#announce_win" do
    it "returns 'X wins!' when the game has ended because a player has won" do
      game = Game.new(Board.new(player_has_won), StubDisplay.new, HumanDouble.new("X", self), HumanDouble.new("O", self))
